...
nnoremap <silent> st :<C-u>Dgrep<CR>
nnoremap <silent> sd :<C-u>Denite file/rec<CR>
nnoremap <silent> s; :<C-u>Denite command command_history<CR>
nnoremap <silent> sp :<C-u>Denite -resume<CR>
